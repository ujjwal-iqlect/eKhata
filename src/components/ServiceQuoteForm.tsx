        ...
        return (
          <>
            <CardHeader>
              ...
              <CardDescription>
                Tell us about your Bengaluru property to help us understand your
                needs.
              </CardDescription>
            </CardHeader>
        ...
        return (
          <>
            <CardHeader>
              ...
              <CardDescription>
                Any other details that might help us understand your case
                better.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="rounded-lg border p-4 bg-primary/5">
                <p className="text-sm">
                  ...
                  regarding your e-Khata service request. We'll send you a
                  detailed quote based on your specific scenario.
                </p>
              </div>
            </CardContent>
          </>
